...
class trainer:
    ...
    def train(self, train_loader, valid_loader):
        ...
        for epoch in range(start + 1, self.config.epochs):
            ...
            writer.add_scalar('Testing loss by steps', eval_loss / len(valid_loader), epoch)
            writer.add_scalar('Testing accuracy by steps', eval_acc / len(valid_loader), epoch)
            print("test_loss: " + str(eval_loss / len(valid_loader)))
            print("test_acc:" + str(eval_acc / len(valid_loader)) + '\n')
            checkpoint = {
...
train_data = DecalsDataset(annotations_file="/data/renhaoye/decals_2022/dataset_txt/overlap_train.txt", transform=data_config.transfer)
...
valid_data = DecalsDataset(annotations_file="/data/renhaoye/decals_2022/dataset_txt/overlap_valid.txt", transform=data_config.transfer)
